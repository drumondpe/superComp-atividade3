/*
Exercício: Implemente uma função para multiplicação de matrizes 
que utiliza const para garantir que as matrizes de entrada não sejam modificadas.

Crie uma classe Matriz que encapsule as operações básicas de uma 
matriz quadrada, utilizando métodos const para operações de leitura.
*/
